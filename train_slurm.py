...
group.add_argument('--save-ckpt', default=False, action='store_true',
                   help='Wether to save checkpoint')
...
parser.add_argument('--launcher', choices=['none', 'pytorch', 'slurm', 'mpi'], default='slurm', help='job launcher')
parser.add_argument('--dist-backend', type=str, default='nccl')
parser.add_argument('--port', type=int, default='12345')
parser.add_argument('--deepspeed', default=False, help='using zero')                   
